...
public class Mod implements Comparable<Mod> {
    ...
    public Mod(String id, String name, String version, String gameVersion, boolean enabled) {
        this.id = id;
        this.name = name;
    ...
    public static Mod fromModInfoFile(File modInfoFile) throws IOException {
